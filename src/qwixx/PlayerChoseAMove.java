...
class PlayerChoseAMove extends JDialog {
    ...
    public PlayerChoseAMove (Player player, Move.MOVETYPE type, SheetEntry se) {
    ...
    public void buildAndShow () {
        ...
        if (type == Move.MOVETYPE.COLORS) h = MoveSelect.HIGHLIGHT.COLOR;
        if (type == Move.MOVETYPE.WHITES) h = MoveSelect.HIGHLIGHT.WHITE;
