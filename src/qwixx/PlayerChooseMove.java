...
class PlayerChooseMove extends JDialog {
    ...
    public Move.MOVETYPE type = Move.MOVETYPE.WHITES;
    

    public PlayerChooseMove (Player player, Move.MOVETYPE type, ArrayList<Move> whiteMoves, ArrayList<Move> colorMoves) {
    ...
    public PlayerChooseMove (Player player, Move.MOVETYPE type, ArrayList<Move> moves) {
